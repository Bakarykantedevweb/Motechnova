...
(window.theme = theme),
    (function () {
        var e;
        // document.getElementById("earningFormateur") &&
        //     ((e = {
        //         series: [
        //             {
        //                 name: "Current Month",
        ...
        //         ],
        //     }),
        //     new ApexCharts(document.querySelector("#earningFormateur"), e).render()),
            document.getElementById("earningTwo") &&
                ((e = {
                    series: [
                        {
                            name: "Current Month",
                            data: [
                                10, 20, 15, 25, 18, 28, 22, 32, 24, 34, 26, 38,
                            ],
                        },
                    ],
                    labels: [
                    ...
                    responsive: [
                        {
                            breakpoint: 575,
                            options: { legend: { offsetY: -30 } },
                        },
                    ],
                }),
                new ApexCharts(
                    document.querySelector("#earningTwo"),
                    e
                ).render()),
                    ...
                    series: [
                        {
                            name: "Days",
                            data: [
                                0, 3, 0.5, 3.5, 1, 2.5, 0.5, 4, 1.4, 4.5, 2.5,
                                4.8,
                            ],
                        },
                    ],
            ...
            document.getElementById("traffic") &&
                ((e = {
                    ...
                    plotOptions: {
                        pie: { expandOnClick: !1, donut: { size: "78%" } },
                    },
                    legend: {
                        labels: {
                            colors: [window.theme.gray500],
            ...
            //     }),
            //     new ApexCharts(
            //         document.querySelector("#orderColumn"),
            //         e
            //     ).render()),
            ...
            document.getElementById("payoutChart") &&
                ((e = {
                    ...
                    tooltip: { enabled: !1 },
                    plotOptions: {
                        bar: { endingShape: "flat", columnWidth: "65%" },
                    },
                    dataLabels: { enabled: !1 },
                    xaxis: {
                        labels: { show: !1 },
                ...
                new ApexCharts(
                    document.querySelector("#payoutChart"),
                    e
                ).render()),
            ...
            document.getElementById("bounceChart") &&
                ...
                new ApexCharts(
                    document.querySelector("#bounceChart"),
                    e
                ).render()),
                    ...
                    series: [
                        {
                            ...
                            data: [
                                600, 1e3, 400, 2e3, 500, 900, 2500, 1800, 3800,
                            ],
                            colors: [window.theme.primary],
                        },
                        {
                            name: "Page Views",
                            data: [
                                1e3, 2e3, 800, 1200, 300, 1900, 1600, 2e3, 1e3,
                            ],
                        },
                        {
                            name: "Total Visits",
                            data: [
                                2200, 1e3, 3400, 900, 500, 2500, 3e3, 1e3, 2500,
                            ],
                        },
                    ],
                    chart: {
            ...
            document.getElementById("support-chart1") &&
                ((e = {
                    ...
                    series: [
                        {
                            data: [
                                25, 66, 41, 70, 63, 25, 44, 22, 36, 19, 54, 44,
                                32, 36, 29, 54, 25, 66, 41, 65, 63, 25, 44, 12,
                                36, 39, 25, 44, 42, 36, 54,
                            ],
                        },
                    ],
                ...
                new ApexCharts(
                    document.querySelector("#support-chart1"),
                    e
                ).render()),
            ...
            document.getElementById("taskSummary") &&
                ...
                new ApexCharts(
                    document.querySelector("#taskSummary"),
                    e
                ).render()),
            ...
            0 < document.querySelectorAll(".taskWireframeChart").length &&
                ((e = {
                    series: [65],
                    chart: { height: 40, width: 80, type: "radialBar" },
                    grid: {
                        show: !1,
                        padding: {
                            left: -15,
            ...
            document.getElementById("taskStatus") &&
                ((e = {
                    ...
                    plotOptions: {
                        pie: { expandOnClick: !1, donut: { size: "75%" } },
                    },
                    legend: {
                        position: "bottom",
                        fontFamily: "inter",

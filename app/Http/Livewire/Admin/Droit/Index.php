...
class Index extends Component
{
    ...
    public function saveDroit()
    {
        ...
        try {
            ...
            $droit->save();
            toastr()->success("Droit ajoute avec success");
            return redirect("admin/droits");
        } catch (\Throwable $th) {
            //throw $th;
    ...
    public function UpdateDroit()
    {
        ...
        try {
            ...
            $droit->route = $validatedData['route'];
            $droit->save();
            toastr()->success("Droit modifié avec success");
            return redirect("admin/droits");
        } catch (\Throwable $th) {
            //throw $th;
            session()->flash('error', $th);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.droit.index',compact('droits'));
    }
}

            ...
            <div class="row gy-4 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between">
                                <span class="fs-6 text-uppercase fw-semibold">Ventes</span>
                                <span class="fe fe-shopping-bag fs-3 text-primary"></span>
                            </div>
                            <h2 class="fw-bold mb-0">{{ $ventesTotal }} FCFA</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                    <div class="card">
                        <div class="card-body d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between">
                                <span class="fs-6 text-uppercase fw-semibold">Cours</span>
                                <span class="fe fe-book-open fs-3 text-primary"></span>
                            </div>
                            <h2 class="fw-bold mb-0">{{ number_format($totalCours, 0, ',', ' ') }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                    <div class="card">
                        <div class="card-body d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between">
                                <span class="fs-6 text-uppercase fw-semibold">Étudiants</span>
                                <span class="fe fe-users fs-3 text-primary"></span>
                            </div>
                            <h2 class="fw-bold mb-0">{{ number_format($totalEtudiants, 0, ',', ' ') }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                    <div class="card">
                        <div class="card-body d-flex flex-column gap-3">
                            <div class="d-flex justify-content-between">
                                <span class="fs-6 text-uppercase fw-semibold">Professeurs</span>
                                <span class="fe fe-user-check fs-3 text-primary"></span>
                            </div>
                            <h2 class="fw-bold mb-0">{{ number_format($totalProfesseurs, 0, ',', ' ') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                    <div class="col-md-3 col-12">
                                        <a href="#"><img
                                                src="{{ asset('assets/images/course/course-gatsby.jpg') }}"
                            ...
                            <li class="list-group-item px-0">
                                <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                    <div class="col-md-3 col-12">
                                        <a href="#">
                                            <img src="{{ asset('assets/images/course/course-javascript.jpg') }}"
                                                alt="" class="img-fluid rounded" />
                                        </a>
                                    </div>
                                    <div class="col-md-8 col-10">
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function() {
                ...
                let chart = new ApexCharts(document.querySelector("#earning"), options);
                chart.render();
            });
        </script>
    @endpush

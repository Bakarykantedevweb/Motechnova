                    ...
                    <div class="card-body p-6 d-flex flex-column gap-4">
                        <div>
                            <div class="d-flex flex-column gap-1">
                                <h1 class="mb-0 fw-bold text-center">Connexion Formateur</h1>
                                <span>
                                    Vous n'avez pas de compte?
                                    <a href="{{ url('formateur/register') }}" class="ms-1">Creez un compte</a>
                                </span>
                            </div>
                        </div>
                        <!-- Form -->
                        <form wire:submit.prevent="login" class="row">
                            ...
                            <div class="mt-2 text-center">
                                ...
                                <a href="#" class="btn-social btn-social-outline btn-twitter">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        fill="currentColor" class="bi bi-twitter mb-1" viewBox="0 0 16 16">
                                        <path
                                ...
                                <a href="#" class="btn-social btn-social-outline btn-linkedin">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        fill="currentColor" class="bi bi-linkedin mb-1" viewBox="0 0 16 16">
                                        <path
                                ...
                                <a href="#" class="btn-social btn-social-outline btn-github">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        fill="currentColor" class="bi bi-github mb-1" viewBox="0 0 16 16">
                                        <path

<div>
    <!-- Bg -->
    <div
        style="background: url({{ asset('assets/images/background/profile-bg.jpg') }}) no-repeat; background-position: center; height: 300px">
    </div>
    <!-- User info -->
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center">
                        <div class="position-relative mt-n8">
                            @if ($formateur->photo)
                                <img src="{{ asset('uploads/formateur/' . $formateur->photo) }}" alt="avatar"
                        ...
                        <div class="d-md-flex justify-content-between w-100 align-items-center">
                            <div class="ms-3">
                                <div class="d-flex align-items-center">
                                    <h3 class="mb-0 fw-bold me-2">{{ $formateur->prenom . ' ' . $formateur->nom }}</h3>
                                    <span class="badge bg-primary-soft">Formateur</span>
                                </div>
                                <span class="fs-6">{{ $formateur->specialites }}</span>
                            </div>
                    ...
                    <div class="card border-0 mb-4 mb-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                <div>
                                    <h4 class="mb-0 fw-bold">{{ $this->formationsTotal }}</h4>
                                    <p class="fs-6 mb-0">Formations</p>
                                </div>
                                <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                <div>
                                    <h4 class="mb-0 fw-bold">{{ $this->etudiantsTotal }}</h4>
                                    <p class="fs-6 mb-0">Etudiants</p>
                                </div>
                                <div>
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-header">
                            <h4 class="mb-0">
                                Mes Formations
                                <span class="fs-6">({{ $formationsTotal }})</span>
                            </h4>
                        </div>
                        <!-- Card body -->
                        <div class="card-body">

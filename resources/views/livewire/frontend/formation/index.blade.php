                            ...
                            <div class="col-12">
                                <div class="row g-0">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/figma.jpg" alt="figma"
                                                class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                <div>
                                                    <span
                                                        class="badge text-light-emphasis bg-light-subtle border border-light-subtle rounded-pill">Design</span>
                                                </div>

                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">Figma UI UX Design Course
                                                            for the Beginner</a>
                                                    </h3>
                                                    <p class="mb-0">
                                                        Lorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit. Nunc hendrerit tellus turpis,
                                                        quis convallis leo venenin consectetur vehicula
                                                        neque non hendrerit.
                                                    </p>
                                ...
                                <div class="row g-0 mb-5">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/python.jpg"
                                                alt="python" class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                <div>
                                                    <span
                                                        class="badge text-light-emphasis bg-light-subtle border border-light-subtle rounded-pill">Web
                                                        Development</span>
                                                </div>

                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">Master the basics of data
                                                            analysis with
                                                            Python</a>
                                                    </h3>
                                                    <p class="mb-0">
                                ...
                                <div class="row g-0 mb-5">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/nuxt.jpg" alt="nuxt"
                                                class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                ...
                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">About the Nuxt.js
                                ...
                                <div class="row g-0 mb-5">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/bootstrap.jpg"
                                                alt="bootstrap" class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                <div>
                                                    <span
                                                        class="badge text-light-emphasis bg-light-subtle border border-light-subtle rounded-pill">Programing</span>
                                                </div>

                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">Create Modern Website
                                                            Using HTML,CSS And
                                                            Bootstrap</a>
                                                    </h3>
                                                    <p class="mb-0">
                                ...
                                <div class="row g-0 mb-5">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/aws.jpg" alt="figma"
                                                class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                ...
                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">AWS Fundamentals
                                                            Specialization</a>
                                                    </h3>
                                                    <p class="mb-0">
                                                        Lorem ipsum dolor sit amet, consectetur
                                ...
                                <div class="row g-0 mb-5">
                                    <div class="col-lg-4 col-md-12">
                                        <a href="#!"><img src="../assets/images/course/mongodb.jpg"
                                                alt="figma" class="img-fluid w-100 rounded mb-4 mb-lg-0" /></a>
                                    </div>
                                    <div class="col-lg-8 col-12 ps-4">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-column gap-3">
                                                ...
                                                <div class="d-flex flex-column gap-2">
                                                    <h3 class="mb-0">
                                                        <a href="#!" class="text-reset">MongoDB - The Complete
                                                            Developer's Guide
                                                            2024</a>
                                                    </h3>
                                                    <p class="mb-0">

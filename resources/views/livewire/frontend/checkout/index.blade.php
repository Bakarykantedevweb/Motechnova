                        ...
                        <form wire:submit.prevent="checkout" class="row g-3 mt-2">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset('images/payment/visa.png') }}" alt="Visa" height="20"
                                            class="me-2">
                ...
                <div class="col-xl-4">
                    <div class="card card-body shadow p-4">
                        ...
                        @foreach ($carts as $cart)
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset($cart->formation->image) }}"
                                        alt="{{ $cart->formation->nom }}" width="80" class="rounded">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1">{{ $cart->formation->nom }}</h6>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted">1 ×</span>
                                        <span class="fw-bold">
                                            {{ number_format($cart->formation->prix_original, 0, ',', ' ') }} FCFA
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold">
                                {{ number_format($carts->sum(function ($item) {return $item->formation->prix_original;}),0,',',' ') }}
                                FCFA
                            </span>
                        </div>
                        ...
                        <div class="alert alert-info mt-4 small">
                            ...
                            Votre accès aux formations sera disponible immédiatement après paiement.
                        </div>
                    </div>
                </div>
            </div>
